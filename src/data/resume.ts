...
export const resumeExperience = {
  ...
  details: [
    ...
    "Recorded 220+ contributions across private enterprise repositories using branch-based development, pull requests, peer code reviews, issue tracking, and Agile delivery practices.",
